...
<img src="https://github.com/awerton89/dip_sf/blob/main/images/Docker_App.JPG">
 ...
 - Сдедующим шагом, создаём манифесты, для деплоя приложения в K3S, на основе Docker образов приложения: <br>
 - Деплоим приложение в K8S кластер.
 
 - Результат деплоя: <br>
 <img src="https://github.com/awerton89/dip_sf/blob/main/images/Kube_app.JPG">
...
-  Результат, наше приложение работает в K8S кластере (kubectl get pods -n diplom -o wide)
...
- Результаты работы CI/CD Pipeline: <br>
  Образы в Dockerhub:
 <img src="https://github.com/awerton89/dip_sf/blob/main/images/Docker_hub_tag.JPG ">  
  Результат работы Pipeline:
 <img src="https://github.com/awerton89/dip_sf/blob/main/images/CICD_deploy_app.JPG">
...
- Вначале добавим repo для Loghouse <br> и устанавливим стэк <b> Fluentd/Clickhouse/Loghouse </b> в namespace "loghouse". <br>
...
- Для мониторнига сервера SRV, доступности нашего приложения "APP-DEP" и кластера "K8S" будем использовать стэк <b>Grafana\Prometheus\Blackbox\Node Exporter\Alertmanager </b><br>
- Весь стэк буду разворачивать на SRV сервере в Docker-compose. <br>
- Путь к манифестам: https://github.com/awerton89/dip_sf/tree/main/monitor/Prometheus_stack <br>
- Разворачиваем стэк командой:  <br>
 <code># docker-compose up -d </code> <br>
- В результате в докере, будет развёрнут полный стэк <b>Grafana\Prometheus\Blackbox\Node Exporter\Alertmanager </b>:<br>   
<img src="https://github.com/awerton89/dip_sf/blob/main/images/grafana1.JPG">
...
<code># kubectl create namespace monitoring <br> </code> <br>
...
- Для отправки уведомлений будем использовать <b> Telegram
